...
//	file_dir = ".\\images\\";
	...
	cout << "Object's RED statistics are (min, average, max, std): ( " << minR << " , " << avgR << ", " << maxR << ", " << stdR << " )" << endl;
	cout << "Object's GREEN statistics are (min, average, max, std): ( " << minG << " , " << avgG << ", " << maxG << ", " << stdG << " )" << endl;
	cout << "Object's BLUE statistics are (min, average, max, std): ( " << minB << " , " << avgB << ", " << maxB << ", " << stdB << " )" << endl;
	...
	outFile << "Object's RED statistics are (min, average, max, std): ( " << minR << " , " << avgR << ", " << maxR << ", " << stdR << " )" << endl;
	outFile << "Object's GREEN statistics are (min, average, max, std): ( " << minG << " , " << avgG << ", " << maxG << ", " << stdG << " )" << endl;
	outFile << "Object's BLUE statistics are (min, average, max, std): ( " << minB << " , " << avgB << ", " << maxB << ", " << stdB << " )" << endl;
...
{
	Mat src, dst, work, mask; // images defs
